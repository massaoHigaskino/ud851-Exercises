...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        if(task.isEmpty()) {
            Toast.makeText(this, "Fill in the task description field.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Uri returnedUri = resolver.insert(TaskContract.TaskEntry.CONTENT_URI, values);
