...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        return new NotificationCompat.Action(android.R.drawable.ic_menu_close_clear_cancel, "IGNORE", pendingIntent);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        return  new NotificationCompat.Action(android.R.drawable.ic_menu_add, "INCREASE", pendingIntent);
    }
