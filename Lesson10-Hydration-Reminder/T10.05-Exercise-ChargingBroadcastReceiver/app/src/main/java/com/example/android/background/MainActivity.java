...
public class MainActivity extends AppCompatActivity implements
    ...
    private void showCharging(boolean charging) {
        mChargingImageView.setImageDrawable(getResources().getDrawable(charging ? R.drawable.ic_power_pink_80px : R.drawable.ic_power_grey_80px));
        mChargingImageView.setImageResource(charging ? R.drawable.ic_power_pink_80px : R.drawable.ic_power_grey_80px);
    }
