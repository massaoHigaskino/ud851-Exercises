...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartySizeEditText.getText().toString().isEmpty()
                || mNewGuestNameEditText.getText().toString().isEmpty()) {
            return;
        }
    ...
    private void addNewGuest(String newGuestName, int newPartySize) {
        ...
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, newGuestName);

        // TODO (7) call put to insert the party size value with the key COLUMN_PARTY_SIZE
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, newPartySize);
